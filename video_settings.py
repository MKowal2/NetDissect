...
MODEL = 'slowonly8x8'                          # model arch: resnet18, alexnet, resnet50, densenet161
...
# OUTPUT_FOLDER = "result/video_a2d_"+MODEL+"_"+DATASET # result will be stored in this folder
OUTPUT_FOLDER = "result/DEBUG_VIDEO_"+MODEL+"_"+DATASET # result will be stored in this folder
